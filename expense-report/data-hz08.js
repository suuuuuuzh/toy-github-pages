...
const expenseItems = [
  ...
  },
  {
    ...
    invoiceAmount: "",
    tpiaoIds: [],
    remark: "[水素] 华住酒店集团（桔子杭州文体中心西溪湿地酒店），微信零钱通支付，2间房 3人。8/10-8/12 两晚：573.30 + 584.80 = 1158.10，酒店减免退款 17.00 → 1141.10；8/12-8/14 续住两晚：593.30 + 642.80 = 1236.10；8/14 一晚 3 间房：900.00；8/15 一晚 3 间房：958.00（建行卡，已含建行优惠 2.00）；8/16 一晚 3 间房：810.00。合计 5045.20。后续堪景酒店费用继续累加到本条。发票到时候一起开",
  },
  {
    id: 5,
    category: "勘景餐饮",
  ...
  },
  {
    ...
    invoiceAmount: "",
    tpiaoIds: [],
    remark: "[水素] 美团，微信零钱通支付。堪景下雨应急物资。发票待开",
  },
  {
    id: 39,
    category: "勘景餐饮",
    description: "8/14 堪景午饭 3人",
    date: "2026-08-14",
    amount: 72.6,
    voucherType: "none",
    invoiceFile: "",
    ...
    invoiceAmount: "",
    tpiaoIds: [],
    remark: "[水素] 春家非遗手工小吃，微信零钱通支付。发票待开",
  },
  {
    id: 40,
    category: "过路过桥费",
    description: "8/14 堪景高速费（杭长高速）",
    date: "2026-08-14",
    amount: 17,
    voucherType: "none",
    invoiceFile: "",
  ...
  },
  {
    ...
    invoiceAmount: "",
    tpiaoIds: [],
    remark: "[水素] 滴滴租车，微信零钱通支付。第二段租期 8/14-8/16，与 id10（8/11-8/13 387.90）是两笔独立租车。发票待开",
  },
  {
    id: 43,
    category: "勘景燃料费",
    description: "8/13 堪景加油",
    date: "2026-08-13",
    amount: 60.97,
    voucherType: "none",
    invoiceFile: "",
    ...
    invoiceAmount: "",
    tpiaoIds: [],
    remark: "[水素] 中海联石油有限公司杭州城西加油站，微信零钱通支付。发票待开",
  },
  {
    id: 44,
    category: "停车费",
    description: "8/13 停车费（杭州天目里）",
    date: "2026-08-13",
    amount: 10,
    voucherType: "none",
    invoiceFile: "",
